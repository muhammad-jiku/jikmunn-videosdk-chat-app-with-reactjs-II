...
const App = () => {
  ...
  const getParams = ({ maxGridSize }) => {
    ...
    const paramKeys = {
      token:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcGlrZXkiOiIzMmY3ZjlkZC1hMTA2LTQ3NjktOWVmNi1jMzgwMDI1YTAyOWUiLCJwZXJtaXNzaW9ucyI6WyJhbGxvd19qb2luIl0sImlhdCI6MTY2MjA0MTAwMSwiZXhwIjoxNjYyNjQ1ODAxfQ.xxFPXDjg43YEQ87owaa8DwLVeqX6WxZoc90LIl91-UY',
